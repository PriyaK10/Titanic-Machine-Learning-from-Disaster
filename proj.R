...
trainset=read.csv("C:/Users/1542283/Desktop/titanic/train.csv")
testset=read.csv("C:/Users/1542283/Desktop/titanic/test.csv")
str(trainset)
...
write.csv(submit,file="C:/Users/1542283/Desktop/titanic/theyallperish.csv",row.names = F)
...
write.csv(submit,file="C:/Users/1542283/Desktop/titanic/myfirstdtree.csv",row.names = F )
?rpart.control

sumbit1=data.frame(PassengerID=trainset$PassengerId, Actual_Survived=trainset$Survived, Predicted_Survived=y_pred2)
write.csv(sumbit1,file="C:/Users/1542283/Desktop/titanic/check.csv",row.names = F )
library(caret)
...
write.csv(submit3, file="C:/Users/1542283/Desktop/titanic/testoutputwithFE.csv",row.names = F)
